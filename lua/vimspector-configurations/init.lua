...
vim.keymap.set('n', '<leader>Db]', function() vim.call('vimspector#JumpToNextBreakpoint') end, {})
vim.keymap.set('n', '<leader>Db[', function() vim.call('vimspector#JumpToPreviousBreakpoint') end, {})
